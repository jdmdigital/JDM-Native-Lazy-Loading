...
function jdmnll_plugin_setup_menu(){
	add_options_page( 'JDM Native Lazy Loading', 'Native Lazy Loading', 'manage_options', 'applicantstack-jobs', 'jdmnll_settings' );
}
...
function jdmnll_settings() {
	if ( !current_user_can( 'manage_options' ) )  {
		wp_die( __( 'You do not have sufficient permissions to access this page. Sorry about that.' ) );
	}
?>
<div class="wrap">
	<h1>Lazy Image Loading Settings</h1>
		...
		<table class="form-table">
			<tbody>
				...
				<tr valign="top">
					...
					<td>
						<?php 
							$nthimg = esc_attr(get_option('jdmnll_nthimg', 'lazy')); 
						?>
	...
	<p>For more information about this new image loading attribute, see our article "<a href="https://jdmdig.it/30nXp7h" target="_blank" rel="noopener nofollow">Native Image Lazy Loading Plugin Released</a>."</p>
</div>
